...
export default function ButtonWsp() {
    return (
        ...
        <>
            {/* WhatsApp Button */}
            <div className="fixed bottom-0 right-0 z-50 w-full max-w-7xl mx-auto pointer-events-none">
                <div className="relative w-full h-0">
                    <div className="absolute bottom-6 right-6 pointer-events-auto">
                        <div className="relative group">
                            ...
                            {/* Tooltip */}
                            <div className="absolute bottom-full right-0 mb-3 px-3 py-2 bg-slate-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-xl">
                                ¡Chatea con nosotros!
